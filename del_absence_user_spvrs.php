...
//$absenceid = $SESSION->block_alerts_generator_spvrs->id_abs; 
$course_id = $SESSION->block_alerts_generator_spvrs->course_id_abs;
...
$abs_count = $DB->count_records('block_alerts_generator_abs_z', array('courseid' => $course_id));
