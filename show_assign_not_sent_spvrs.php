...
$query = "SELECT 	msg.id AS msgid, 
					...
					INNER JOIN {block_alerts_generator_ans_s} AS aga ON msg.id = aga.messageid 			
...
<html>
    <head>
		...
		<title><?php echo get_string('show_assign_not_sent_spvrs_alert', 'block_alerts_generator');?></title>
	...
	<body>	
			...
			$(document).ready(function(){
				...
				$("#container_alerts").on('click', '.btnDelete', function() { 
					...
					if (confirm('<?php echo get_string('confirmation_message', 'block_alerts_generator');?>')) {
						...
						var url = "del_sch_assign_not_sent_spvrs.php";
		...
		<div class="footer_page_link">
			<p><a href="assign_not_sent_spvrs.php?id=<?php echo $course_id;?>" class="">Inserir novo alerta</a></p>
		</div>
		<?php else:  ?>
