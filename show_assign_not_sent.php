...
$query = "SELECT msg.id AS msgid, aga.id AS ag_assignid, a.name, a.duedate, msg.message, msg.subject
			...
			WHERE msg.courseid = ". $course_id . " AND aga.sent = 0 AND  a.course = " . $course_id . " ORDER BY a.name" ; 
...
<html>
    <head>
		...
		<title>Show Assign not sent Alerts</title>
	...
	<div id="dialog_edt_form" >
		...
		<form action="edt_sch_assign_not_sent.php" method="post" name="edtform">
			...
			<p>Se aluno não enviar tarefa: <span class="edt_asgn_name"> </span> </p>
		
			<p>Enviar a mensagem:</p>
	...
	<p><a href="assign_not_sent.php?id=<?php echo $course_id;?>" class="button">Inserir alerta</a></p>
	
	<?php else:  ?>
	
	<div><p>Não há alertas cadastrados</p></div>
