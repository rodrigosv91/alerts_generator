...
$query = "SELECT msg.id AS msgid, aga.id AS ag_assignid, a.name, a.duedate, aga.alerttime, msg.message, msg.subject
...
<html>
	...
	<p><a href="expire_task_alert.php?id=<?php echo $course_id;?>" class="button">Inserir alerta</a></p>
	...
	<?php $result->close() ;// close database connection?>
	</body>
</html>		
